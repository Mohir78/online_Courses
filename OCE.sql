...
SELECT * FROM admin;
select users.Ismi,courses.Nomi
from followers
inner join users on followers.user_id=users.user_id
inner join courses on followers.Kurs=courses.CourseId;
...
CREATE TABLE followers(
    ...
    FOREIGN KEY (Kurs) REFERENCES courses (CourseId)
);
...
INSERT INTO followers(user_id,Kurs)
VALUES(1,1),
(2,2),
(1,3);

INSERT INTO Admin(Ismi, Familiyasi, login, parol)
